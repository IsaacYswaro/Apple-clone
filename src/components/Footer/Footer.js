...
import FooerLinksWrapper from "../Footer/FooterLinkWrapper"
		...
		<div className="container"> 
			...
			<div className="copyright-wrapper row">
				...
				<div className="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
					<div classNameName="flag-wrapper"><img src={Logo}/></div> <div classNameName="footer-country-name">United States</div> 
				</div>
			</div>
		</div>
	</footer> 
